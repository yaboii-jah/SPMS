...
import { add, update, fetchSpms, fetchRatings, submit, fetchAllPerformance} from "../controllers/performanceController.js";
...
routes.get('/fetchPerformance', fetchAllPerformance)
